(module
 ...
 (table 3 3 anyfunc)
 (elem (i32.const 0) $__wasm_nullptr $_ZN13deferred_test9defercallEyyyy $_ZN13deferred_test9deferfuncEy)
 (memory $0 1)
 ...
 (data (i32.const 144) "deferfunc called on \00")
 (data (i32.const 176) " with payload = \00")
 (data (i32.const 208) "value 13 not allowed in payload\00")
 (data (i32.const 240) "defercall called on \00")
 (data (i32.const 272) "deferred send of deferfunc action to \00")
 (data (i32.const 320) " by \00")
 (data (i32.const 336) " with sender id \00")
