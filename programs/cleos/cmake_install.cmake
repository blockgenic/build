# Install script for directory: /home/eos-n1/eos/programs/cleos
...
file(INSTALL DESTINATION "/usr/local/eosio/bin" TYPE EXECUTABLE FILES "/home/eos-n1/eos/build/programs/cleos/cleos")
  if(EXISTS "$ENV{DESTDIR}/usr/local/eosio/bin/cleos" AND
     NOT IS_SYMLINK "$ENV{DESTDIR}/usr/local/eosio/bin/cleos")
