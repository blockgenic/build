...
(module
 ...
 (data (i32.const 544) "idx64_general - table.require_find() of existing primary key\00")
 (data (i32.const 608) "charlie\00")
 (data (i32.const 624) "idx64_general - secondary_index.lower_bound()\00")
 (data (i32.const 672) "idx64_general - increment secondary iterator\00")
 (data (i32.const 720) "joe\00")
 (data (i32.const 736) "idx64_general - increment secondary iterator again\00")
 (data (i32.const 800) "idx64_general - increment secondary iterator to end\00")
 (data (i32.const 864) "bob\00")
 (data (i32.const 880) "idx64_general - iterator to existing object in secondary index\00")
 (data (i32.const 944) "idx64_general - decrement secondary iterator\00")
 (data (i32.const 992) "allyson\00")
 (data (i32.const 1008) "idx64_general - decrement secondary iterator again\00")
 (data (i32.const 1072) "alice\00")
 (data (i32.const 1088) "idx64_general - decrement secondary iterator to beginning\00")
 (data (i32.const 1152) "idx64_general - unexpected continuation of secondary index in reverse iteration\00")
 (data (i32.const 1232) "idx64_general - primary key mismatch in reverse iteration\00")
 (data (i32.const 1296) "idx64_general - did not iterate backwards through secondary index properly\00")
 (data (i32.const 1376) "unable to find secondary key\00")
 (data (i32.const 1408) "idx64_general - require_find must never return end iterator\00")
 (data (i32.const 1472) "idx64_general - require_find test\00")
 (data (i32.const 1520) "idx64_general - require_find secondary key test\00")
 (data (i32.const 1568) "cannot pass end iterator to modify\00")
 (data (i32.const 1616) "billy\00")
 (data (i32.const 1632) "idx64_general - table.modify()\00")
 (data (i32.const 1664) "cannot pass end iterator to erase\00")
 (data (i32.const 1712) "idx64_general - table.erase()\00")
 (data (i32.const 1744) "object passed to erase is not in multi_index\00")
 (data (i32.const 1792) "cannot erase objects in table of another contract\00")
 (data (i32.const 1856) "attempt to remove object that was not in multi_index\00")
 (data (i32.const 1920) "object passed to modify is not in multi_index\00")
 (data (i32.const 1968) "cannot modify objects in table of another contract\00")
 (data (i32.const 2032) "updater cannot change primary key when modifying an object\00")
 ...
 (data (i32.const 2208) "error reading iterator\00")
 (data (i32.const 2240) "read\00")
 (data (i32.const 2256) "idx128_general - secondary key sort\00")
 (data (i32.const 2304) "table not loaded\00")
 (data (i32.const 2336) "unable to find primary key in require_find\00")
 (data (i32.const 2384) "bill\00")
 (data (i32.const 2400) "frank\00")
 (data (i32.const 2416) "unable to find sec key\00")
 (data (i32.const 2448) "idx128_autoincrement_test - did not iterate through secondary index properly\00")
 (data (i32.const 2528) "idx128_autoincrement_test - could not find object with primary key of 3\00")
 (data (i32.const 2608) "next primary key in table is at autoincrement limit\00")
 (data (i32.const 2672) "idx128_autoincrement_test - next_primary_key was not correct after record modify\00")
 (data (i32.const 2768) "idx128_autoincrement_test - unexpected primary key\00")
 (data (i32.const 2832) "cannot decrement end iterator when the table is empty\00")
 (data (i32.const 2896) "cannot decrement iterator at beginning of table\00")
 (data (i32.const 2944) "idx128_autoincrement_test_part1 - did not iterate through secondary index properly\00")
 (data (i32.const 3040) "idx128_autoincrement_test_part1 - unexpected primary key\00")
 (data (i32.const 3104) "idx128_autoincrement_test_part2 - did not recover expected next primary key\00")
 (data (i32.const 3184) "idx128_autoincrement_test_part2 - did not iterate through secondary index properly\00")
 (data (i32.const 3280) "idx128_autoincrement_test_part2 - could not find object with primary key of 3\00")
 (data (i32.const 3360) "idx128_autoincrement_test_part2 - next_primary_key was not correct after record update\00")
 (data (i32.const 3456) "idx128_autoincrement_test_part2 - unexpected primary key\00")
 (data (i32.const 3520) "Testing key256 secondary index.\n\00")
 (data (i32.const 3568) "unexpected error in fixed_key constructor\00")
 (data (i32.const 3616) "Items sorted by primary key:\n\00")
 (data (i32.const 3648) " ID=\00")
 (data (i32.const 3664) ", secondary=\00")
 (data (i32.const 3680) "\n\00")
 (data (i32.const 3696) "idx256_general - primary key sort\00")
 (data (i32.const 3744) "First entry with a secondary key of at least 40 has ID=\00")
 (data (i32.const 3808) ".\n\00")
 (data (i32.const 3824) "idx256_general - lower_bound\00")
 (data (i32.const 3856) "First entry with a secondary key of at least 50 has ID=\00")
 (data (i32.const 3920) "Previously found entry is the same as the one found earlier with a primary key value of 2.\n\00")
 (data (i32.const 4016) "Items sorted by secondary key (key256):\n\00")
 (data (i32.const 4064) "idx256_general - secondary key sort\00")
 (data (i32.const 4112) "First entry with a secondary key greater than 42 has ID=\00")
 (data (i32.const 4176) "idx256_general - upper_bound\00")
 (data (i32.const 4208) "idx256_general - secondary index get\00")
 (data (i32.const 4256) "Removed entry with ID=\00")
 (data (i32.const 4288) "Items reverse sorted by primary key:\n\00")
 (data (i32.const 4336) "idx256_general - primary key sort after remove\00")
 (data (i32.const 4384) "0x\00")
 (data (i32.const 4400) "Testing double secondary index.\n\00")
 (data (i32.const 4448) "tolerance = \00")
 (data (i32.const 4464) "expected_product = \00")
 (data (i32.const 4496) "idx_double_general - did not iterate through secondary index properly\00")
 (data (i32.const 4576) "idx_double_general - lower_bound\00")
 (data (i32.const 4624) "idx_double_general - upper_bound\00")
 (data (i32.const 4672) "idx_double_general - unexpected primary key\00")
 (data (i32.const 4720) " id = \00")
 (data (i32.const 4736) ", sec = \00")
 (data (i32.const 4752) ", sec * id = \00")
 (data (i32.const 4768) "idx_double_general - product of secondary and id not equal to expected_product within tolerance\00")
 (data (i32.const 4864) "Testing long double secondary index.\n\00")
 (data (i32.const 4912) "idx_long_double_general - did not iterate through secondary index properly\00")
 (data (i32.const 4992) "idx_long_double_general - lower_bound\00")
 (data (i32.const 5040) "idx_long_double_general - upper_bound\00")
 (data (i32.const 5088) "idx_long_double_general - unexpected primary key\00")
 (data (i32.const 5152) "idx_long_double_general - product of secondary and id not equal to expected_product within tolerance\00")
 (data (i32.const 5264) "idx64_pass_pk_ref_to_other_table - table.find() of existing primary key\00")
 (data (i32.const 5344) "idx64_pass_sk_ref_to_other_table - table.find() of existing primary key\00")
 (data (i32.const 5424) "idx64_modify_primary_key - table.find() of existing primary key\00")
 (data (i32.const 5488) "idx64_run_out_of_avl_pk - incorrect available primary key\00")
 (data (i32.const 5552) "idx64_sk_cache_pk_lookup - sec_index.find() of existing secondary key\00")
 (data (i32.const 5632) "idx64_sk_cache_pk_lookup - previous record\00")
 (data (i32.const 5680) "idx64_pk_cache_sk_lookup - table.find() of existing primary key\00")
 (data (i32.const 5744) "idx64_pk_cache_sk_lookup - next record\00")
 (data (i32.const 5792) "Unknown Test\00")
 ...
 (export "_ZN16test_multi_index23idx64_require_find_failEyyy" (func $_ZN16test_multi_index23idx64_require_find_failEyyy))
 (export "_ZN16test_multi_index32idx64_require_find_fail_with_msgEyyy" (func $_ZN16test_multi_index32idx64_require_find_fail_with_msgEyyy))
 (export "_ZN16test_multi_index26idx64_require_find_sk_failEyyy" (func $_ZN16test_multi_index26idx64_require_find_sk_failEyyy))
 (export "_ZN16test_multi_index35idx64_require_find_sk_fail_with_msgEyyy" (func $_ZN16test_multi_index35idx64_require_find_sk_fail_with_msgEyyy))
 ...
 (func $_ZN17_test_multi_index27idx64_check_without_storingILy8417982951132398080EEEvy (param $0 i64)
  ...
  (call $_ZNK5eosio11multi_indexILy8417982951132398080EN17_test_multi_index12record_idx64EJNS_10indexed_byILy4589348694149954560EN5boost11multi_index13const_mem_funIS2_yXadL_ZNKS2_13get_secondaryEvEEEEEEEE12require_findEyPKc
   (i32.add
    (get_local $12)
    (i32.const 48)
   )
 ...
 (func $_ZNK5eosio11multi_indexILy8417982951132398080EN17_test_multi_index12record_idx64EJNS_10indexed_byILy4589348694149954560EN5boost11multi_index13const_mem_funIS2_yXadL_ZNKS2_13get_secondaryEvEEEEEEEE12require_findEyPKc (param $0 i32) (param $1 i32) (param $2 i64) (param $3 i32)
  (local $4 i32)
  (local $5 i32)
  (local $6 i32)
  (local $7 i32)
 ...
 (func $_ZN17_test_multi_index27idx64_check_without_storingILy8417982951132398592EEEvy (param $0 i64)
  ...
  (call $_ZNK5eosio11multi_indexILy8417982951132398592EN17_test_multi_index12record_idx64EJNS_10indexed_byILy4589348694149954560EN5boost11multi_index13const_mem_funIS2_yXadL_ZNKS2_13get_secondaryEvEEEEEEEE12require_findEyPKc
   (i32.add
    (get_local $12)
    (i32.const 48)
   )
 ...
 (func $_ZNK5eosio11multi_indexILy8417982951132398592EN17_test_multi_index12record_idx64EJNS_10indexed_byILy4589348694149954560EN5boost11multi_index13const_mem_funIS2_yXadL_ZNKS2_13get_secondaryEvEEEEEEEE12require_findEyPKc (param $0 i32) (param $1 i32) (param $2 i64) (param $3 i32)
  (local $4 i32)
  (local $5 i32)
  (local $6 i32)
  (local $7 i32)
 ...
 (func $_ZN16test_multi_index23idx64_require_find_failEyyy (param $0 i64) (param $1 i64) (param $2 i64)
  (call $_ZN17_test_multi_index16idx64_store_onlyILy8417982951132400128EEEvy
   (get_local $0)
  )
  (call $_ZN17_test_multi_index23idx64_require_find_failILy8417982951132400128EEEvy
   (get_local $0)
  )
 )
 (func $_ZN17_test_multi_index16idx64_store_onlyILy8417982951132400128EEEvy (param $0 i64)
  (local $1 i32)
  (local $2 i32)
  (local $3 i32)
  (local $4 i32)
  ...
  (loop $label$0
   ...
   (call $_ZN5eosio11multi_indexILy8417982951132400128EN17_test_multi_index12record_idx64EJNS_10indexed_byILy4589348694149954560EN5boost11multi_index13const_mem_funIS2_yXadL_ZNKS2_13get_secondaryEvEEEEEEEE7emplaceIZNS1_16idx64_store_onlyILy8417982951132400128EEEvyEUlRT_E_EENS9_14const_iteratorEyOSC_
    (get_local $5)
    (i32.add
     (get_local $5)
     (i32.const 24)
 ...
 (func $_ZN17_test_multi_index23idx64_require_find_failILy8417982951132400128EEEvy (param $0 i64)
  (local $1 i32)
  (local $2 i32)
  (local $3 i32)
  (local $4 i32)
  ...
  (call $_ZNK5eosio11multi_indexILy8417982951132400128EN17_test_multi_index12record_idx64EJEE12require_findEyPKc
   (i32.add
    (get_local $5)
    (i32.const 16)
   )
 ...
 (func $_ZNK5eosio11multi_indexILy8417982951132400128EN17_test_multi_index12record_idx64EJEE12require_findEyPKc (param $0 i32) (param $1 i32) (param $2 i64) (param $3 i32)
  (local $4 i32)
  (local $5 i32)
  (local $6 i32)
  (local $7 i32)
  ...
  (block $label$2
   ...
   (call $eosio_assert
    (i32.eq
     (i32.load offset=16
      (tee_local $7
       (call $_ZNK5eosio11multi_indexILy8417982951132400128EN17_test_multi_index12record_idx64EJEE31load_object_by_primary_iteratorEl
        (get_local $1)
        (get_local $7)
       )
      )
 ...
 (func $_ZNK5eosio11multi_indexILy8417982951132400128EN17_test_multi_index12record_idx64EJEE31load_object_by_primary_iteratorEl (param $0 i32) (param $1 i32) (result i32)
  (local $2 i32)
  (local $3 i32)
  (local $4 i32)
  (local $5 i64)
  ...
  (block $label$2
   ...
   (block $label$6
    ...
    (call $_ZNSt3__16vectorIN5eosio11multi_indexILy8417982951132400128EN17_test_multi_index12record_idx64EJEE8item_ptrENS_9allocatorIS6_EEE24__emplace_back_slow_pathIJNS_10unique_ptrINS5_4itemENS_14default_deleteISC_EEEERyRlEEEvDpOT_
     (i32.add
      (get_local $0)
      (i32.const 24)
     )
 ...
 (func $_ZNSt3__16vectorIN5eosio11multi_indexILy8417982951132400128EN17_test_multi_index12record_idx64EJEE8item_ptrENS_9allocatorIS6_EEE24__emplace_back_slow_pathIJNS_10unique_ptrINS5_4itemENS_14default_deleteISC_EEEERyRlEEEvDpOT_ (param $0 i32) (param $1 i32) (param $2 i32) (param $3 i32)
  (local $4 i32)
  (local $5 i32)
  (local $6 i32)
  (local $7 i32)
 ...
 (func $_ZN5eosio11multi_indexILy8417982951132400128EN17_test_multi_index12record_idx64EJNS_10indexed_byILy4589348694149954560EN5boost11multi_index13const_mem_funIS2_yXadL_ZNKS2_13get_secondaryEvEEEEEEEE7emplaceIZNS1_16idx64_store_onlyILy8417982951132400128EEEvyEUlRT_E_EENS9_14const_iteratorEyOSC_ (param $0 i32) (param $1 i32) (param $2 i64) (param $3 i32)
  (local $4 i32)
  (local $5 i32)
  (local $6 i32)
  (local $7 i32)
  ...
  (call $_ZZN5eosio11multi_indexILy8417982951132400128EN17_test_multi_index12record_idx64EJNS_10indexed_byILy4589348694149954560EN5boost11multi_index13const_mem_funIS2_yXadL_ZNKS2_13get_secondaryEvEEEEEEEE7emplaceIZNS1_16idx64_store_onlyILy8417982951132400128EEEvyEUlRT_E_EENS9_14const_iteratorEyOSC_ENKUlSD_E_clINS9_4itemEEEDaSD_
   (i32.add
    (get_local $7)
    (i32.const 16)
   )
  ...
  (block $label$0
   ...
   (call $_ZNSt3__16vectorIN5eosio11multi_indexILy8417982951132400128EN17_test_multi_index12record_idx64EJNS1_10indexed_byILy4589348694149954560EN5boost11multi_index13const_mem_funIS4_yXadL_ZNKS4_13get_secondaryEvEEEEEEEE8item_ptrENS_9allocatorISC_EEE24__emplace_back_slow_pathIJNS_10unique_ptrINSB_4itemENS_14default_deleteISI_EEEERyRlEEEvDpOT_
    (i32.add
     (get_local $1)
     (i32.const 24)
    )
 ...
 (func $_ZZN5eosio11multi_indexILy8417982951132400128EN17_test_multi_index12record_idx64EJNS_10indexed_byILy4589348694149954560EN5boost11multi_index13const_mem_funIS2_yXadL_ZNKS2_13get_secondaryEvEEEEEEEE7emplaceIZNS1_16idx64_store_onlyILy8417982951132400128EEEvyEUlRT_E_EENS9_14const_iteratorEyOSC_ENKUlSD_E_clINS9_4itemEEEDaSD_ (param $0 i32) (param $1 i32)
  (local $2 i32)
  (local $3 i64)
  (local $4 i32)
  (local $5 i64)
 ...
 (func $_ZNSt3__16vectorIN5eosio11multi_indexILy8417982951132400128EN17_test_multi_index12record_idx64EJNS1_10indexed_byILy4589348694149954560EN5boost11multi_index13const_mem_funIS4_yXadL_ZNKS4_13get_secondaryEvEEEEEEEE8item_ptrENS_9allocatorISC_EEE24__emplace_back_slow_pathIJNS_10unique_ptrINSB_4itemENS_14default_deleteISI_EEEERyRlEEEvDpOT_ (param $0 i32) (param $1 i32) (param $2 i32) (param $3 i32)
  (local $4 i32)
  (local $5 i32)
  (local $6 i32)
  (local $7 i32)
 ...
 (func $_ZN16test_multi_index32idx64_require_find_fail_with_msgEyyy (param $0 i64) (param $1 i64) (param $2 i64)
  (call $_ZN17_test_multi_index16idx64_store_onlyILy8417982951132397568EEEvy
   (get_local $0)
  )
  (call $_ZN17_test_multi_index32idx64_require_find_fail_with_msgILy8417982951132397568EEEvy
   (get_local $0)
  )
 )
 (func $_ZN17_test_multi_index16idx64_store_onlyILy8417982951132397568EEEvy (param $0 i64)
  (local $1 i32)
  (local $2 i32)
  (local $3 i32)
  (local $4 i32)
  ...
  (loop $label$0
   ...
   (call $_ZN5eosio11multi_indexILy8417982951132397568EN17_test_multi_index12record_idx64EJNS_10indexed_byILy4589348694149954560EN5boost11multi_index13const_mem_funIS2_yXadL_ZNKS2_13get_secondaryEvEEEEEEEE7emplaceIZNS1_16idx64_store_onlyILy8417982951132397568EEEvyEUlRT_E_EENS9_14const_iteratorEyOSC_
    (get_local $5)
    (i32.add
     (get_local $5)
     (i32.const 24)
 ...
 (func $_ZN17_test_multi_index32idx64_require_find_fail_with_msgILy8417982951132397568EEEvy (param $0 i64)
  (local $1 i32)
  (local $2 i32)
  (local $3 i32)
  (local $4 i32)
  ...
  (call $_ZNK5eosio11multi_indexILy8417982951132397568EN17_test_multi_index12record_idx64EJEE12require_findEyPKc
   (i32.add
    (get_local $5)
    (i32.const 16)
   )
 ...
 (func $_ZNK5eosio11multi_indexILy8417982951132397568EN17_test_multi_index12record_idx64EJEE12require_findEyPKc (param $0 i32) (param $1 i32) (param $2 i64) (param $3 i32)
  (local $4 i32)
  (local $5 i32)
  (local $6 i32)
  (local $7 i32)
  ...
  (block $label$2
   ...
   (call $eosio_assert
    (i32.eq
     (i32.load offset=16
      (tee_local $7
       (call $_ZNK5eosio11multi_indexILy8417982951132397568EN17_test_multi_index12record_idx64EJEE31load_object_by_primary_iteratorEl
        (get_local $1)
        (get_local $7)
       )
      )
 ...
 (func $_ZNK5eosio11multi_indexILy8417982951132397568EN17_test_multi_index12record_idx64EJEE31load_object_by_primary_iteratorEl (param $0 i32) (param $1 i32) (result i32)
  (local $2 i32)
  (local $3 i32)
  (local $4 i32)
  (local $5 i64)
  ...
  (block $label$2
   ...
   (block $label$6
    ...
    (call $_ZNSt3__16vectorIN5eosio11multi_indexILy8417982951132397568EN17_test_multi_index12record_idx64EJEE8item_ptrENS_9allocatorIS6_EEE24__emplace_back_slow_pathIJNS_10unique_ptrINS5_4itemENS_14default_deleteISC_EEEERyRlEEEvDpOT_
     (i32.add
      (get_local $0)
      (i32.const 24)
     )
 ...
 (func $_ZNSt3__16vectorIN5eosio11multi_indexILy8417982951132397568EN17_test_multi_index12record_idx64EJEE8item_ptrENS_9allocatorIS6_EEE24__emplace_back_slow_pathIJNS_10unique_ptrINS5_4itemENS_14default_deleteISC_EEEERyRlEEEvDpOT_ (param $0 i32) (param $1 i32) (param $2 i32) (param $3 i32)
  (local $4 i32)
  (local $5 i32)
  (local $6 i32)
  (local $7 i32)
 ...
 (func $_ZN5eosio11multi_indexILy8417982951132397568EN17_test_multi_index12record_idx64EJNS_10indexed_byILy4589348694149954560EN5boost11multi_index13const_mem_funIS2_yXadL_ZNKS2_13get_secondaryEvEEEEEEEE7emplaceIZNS1_16idx64_store_onlyILy8417982951132397568EEEvyEUlRT_E_EENS9_14const_iteratorEyOSC_ (param $0 i32) (param $1 i32) (param $2 i64) (param $3 i32)
  (local $4 i32)
  (local $5 i32)
  (local $6 i32)
  (local $7 i32)
  ...
  (call $_ZZN5eosio11multi_indexILy8417982951132397568EN17_test_multi_index12record_idx64EJNS_10indexed_byILy4589348694149954560EN5boost11multi_index13const_mem_funIS2_yXadL_ZNKS2_13get_secondaryEvEEEEEEEE7emplaceIZNS1_16idx64_store_onlyILy8417982951132397568EEEvyEUlRT_E_EENS9_14const_iteratorEyOSC_ENKUlSD_E_clINS9_4itemEEEDaSD_
   (i32.add
    (get_local $7)
    (i32.const 16)
   )
  ...
  (block $label$0
   ...
   (call $_ZNSt3__16vectorIN5eosio11multi_indexILy8417982951132397568EN17_test_multi_index12record_idx64EJNS1_10indexed_byILy4589348694149954560EN5boost11multi_index13const_mem_funIS4_yXadL_ZNKS4_13get_secondaryEvEEEEEEEE8item_ptrENS_9allocatorISC_EEE24__emplace_back_slow_pathIJNS_10unique_ptrINSB_4itemENS_14default_deleteISI_EEEERyRlEEEvDpOT_
    (i32.add
     (get_local $1)
     (i32.const 24)
    )
 ...
 (func $_ZZN5eosio11multi_indexILy8417982951132397568EN17_test_multi_index12record_idx64EJNS_10indexed_byILy4589348694149954560EN5boost11multi_index13const_mem_funIS2_yXadL_ZNKS2_13get_secondaryEvEEEEEEEE7emplaceIZNS1_16idx64_store_onlyILy8417982951132397568EEEvyEUlRT_E_EENS9_14const_iteratorEyOSC_ENKUlSD_E_clINS9_4itemEEEDaSD_ (param $0 i32) (param $1 i32)
  (local $2 i32)
  (local $3 i64)
  (local $4 i32)
  (local $5 i64)
 ...
 (func $_ZNSt3__16vectorIN5eosio11multi_indexILy8417982951132397568EN17_test_multi_index12record_idx64EJNS1_10indexed_byILy4589348694149954560EN5boost11multi_index13const_mem_funIS4_yXadL_ZNKS4_13get_secondaryEvEEEEEEEE8item_ptrENS_9allocatorISC_EEE24__emplace_back_slow_pathIJNS_10unique_ptrINSB_4itemENS_14default_deleteISI_EEEERyRlEEEvDpOT_ (param $0 i32) (param $1 i32) (param $2 i32) (param $3 i32)
  (local $4 i32)
  (local $5 i32)
  (local $6 i32)
  (local $7 i32)
 ...
 (func $_ZN16test_multi_index26idx64_require_find_sk_failEyyy (param $0 i64) (param $1 i64) (param $2 i64)
  (call $_ZN17_test_multi_index16idx64_store_onlyILy8417982951132397568EEEvy
   (get_local $0)
  )
  (call $_ZN17_test_multi_index26idx64_require_find_sk_failILy8417982951132397568EEEvy
   (get_local $0)
  )
 )
 (func $_ZN17_test_multi_index26idx64_require_find_sk_failILy8417982951132397568EEEvy (param $0 i64)
  (local $1 i32)
  (local $2 i32)
  (local $3 i32)
  (local $4 i32)
  ...
  (call $_ZNK5eosio11multi_indexILy8417982951132397568EN17_test_multi_index12record_idx64EJNS_10indexed_byILy4589348694149954560EN5boost11multi_index13const_mem_funIS2_yXadL_ZNKS2_13get_secondaryEvEEEEEEEE5indexILy4589348694149954560ES7_Ly0ELb0EE11lower_boundERKy
   (i32.add
    (get_local $8)
    (i32.const 24)
   )
 ...
 (func $_ZNK5eosio11multi_indexILy8417982951132397568EN17_test_multi_index12record_idx64EJNS_10indexed_byILy4589348694149954560EN5boost11multi_index13const_mem_funIS2_yXadL_ZNKS2_13get_secondaryEvEEEEEEEE5indexILy4589348694149954560ES7_Ly0ELb0EE11lower_boundERKy (param $0 i32) (param $1 i32) (param $2 i32)
  (local $3 i32)
  (local $4 i32)
  (local $5 i64)
  (local $6 i32)
   ...
   (block $label$3
    ...
    (call $eosio_assert
     (i32.eq
      (i32.load offset=16
       (tee_local $2
        (call $_ZNK5eosio11multi_indexILy8417982951132397568EN17_test_multi_index12record_idx64EJNS_10indexed_byILy4589348694149954560EN5boost11multi_index13const_mem_funIS2_yXadL_ZNKS2_13get_secondaryEvEEEEEEEE31load_object_by_primary_iteratorEl
         (get_local $4)
         (call $db_find_i64
          (i64.load
           (get_local $4)
 ...
 (func $_ZNK5eosio11multi_indexILy8417982951132397568EN17_test_multi_index12record_idx64EJNS_10indexed_byILy4589348694149954560EN5boost11multi_index13const_mem_funIS2_yXadL_ZNKS2_13get_secondaryEvEEEEEEEE31load_object_by_primary_iteratorEl (param $0 i32) (param $1 i32) (result i32)
  (local $2 i32)
  (local $3 i32)
  (local $4 i32)
  (local $5 i64)
 ...
 (func $_ZN16test_multi_index35idx64_require_find_sk_fail_with_msgEyyy (param $0 i64) (param $1 i64) (param $2 i64)
  (call $_ZN17_test_multi_index16idx64_store_onlyILy8417982951132397568EEEvy
   (get_local $0)
  )
  (call $_ZN17_test_multi_index35idx64_require_find_sk_fail_with_msgILy8417982951132397568EEEvy
   (get_local $0)
  )
 )
 (func $_ZN17_test_multi_index35idx64_require_find_sk_fail_with_msgILy8417982951132397568EEEvy (param $0 i64)
  (local $1 i32)
  (local $2 i32)
  (local $3 i32)
  (local $4 i32)
                                    ...
                                    (block $label$34
                                     (block $label$35
                                      (block $label$36
                                       (block $label$37
                                        (br_if $label$37
                                         (i64.gt_s
                                          (get_local $2)
                                          (i64.const -5598011838000951934)
                                         )
                                        )
                                        (br_if $label$36
                                         (i64.le_s
                                          (get_local $2)
                                          (i64.const -5598011839179942918)
                                         )
                                        )
                                        (br_if $label$34
                                         (i64.gt_s
                                          (get_local $2)
                                          (i64.const -5598011838386844351)
                                         )
                                        )
                                        (br_if $label$30
                                         (i64.gt_s
                                          (get_local $2)
                                          (i64.const -5598011838968643457)
                                         )
                                        )
                                        (br_if $label$22
                                         (i64.eq
                                          (get_local $2)
                                          (i64.const -5598011839179942917)
                                         )
                                        )
                                        (br_if $label$2
                                         (i64.ne
                                       ...
                                       (br_if $label$29
                                        (i64.gt_s
                                         (get_local $2)
                                         (i64.const -5598011836975719096)
                                        )
                                       )
                                       (br_if $label$21
                                        (i64.eq
                                         (get_local $2)
                                         (i64.const -5598011837248771168)
                                        )
                                       )
                                       (br_if $label$2
                                        (i64.ne
                                      ...
                                      (br_if $label$32
                                       (i64.gt_s
                                        (get_local $2)
                                        (i64.const -5598011840126259182)
                                       )
                                      )
                                      (br_if $label$26
                                       (i64.gt_s
                                        (get_local $2)
                                        (i64.const -5598011840277932830)
                                       )
                                      )
                                      (br_if $label$20
                                       (i64.eq
                                     ...
                                     (br_if $label$31
                                      (i64.le_s
                                       (get_local $2)
                                       (i64.const -5598011837643834019)
                                      )
                                     )
                                     (br_if $label$25
                                      (i64.gt_s
                                       (get_local $2)
                                       (i64.const -5598011837515550682)
                                      )
                                     )
                                     (br_if $label$19
                                      (i64.eq
 ...
 (func $_ZN5eosio14memory_manager16next_active_heapEv (param $0 i32) (result i32)
  ...
  (block $label$0
   (block $label$1
    (br_if $label$1
     (i32.eqz
      (i32.load8_u offset=14294
       (i32.const 0)
      )
     )
    )
    (set_local $7
     (i32.load offset=14296
      (i32.const 0)
     )
    )
    (br $label$0)
   ...
   (i32.store8 offset=14294
    (i32.const 0)
    (i32.const 1)
   )
   (i32.store offset=14296
    (i32.const 0)
    (tee_local $7
     (i32.shl
      (get_local $7)
