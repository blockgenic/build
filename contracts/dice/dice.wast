(module
 ...
 (data (i32.const 1520) "multiplication underflow\00")
 (data (i32.const 1552) "offer not found\00")
 (data (i32.const 1568) "unable to reveal\00")
 (data (i32.const 1600) "player already revealed\00")
 (data (i32.const 1632) "offer does not exists\00")
 (data (i32.const 1664) "unable to cancel offer\00")
 (data (i32.const 1696) "only core token allowed\00")
 (data (i32.const 1728) "invalid bet\00")
 (data (i32.const 1744) "must bet positive quantity\00")
 (data (i32.const 1776) "offer with this commitment already exist\00")
