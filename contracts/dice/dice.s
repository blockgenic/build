...
.LBB12_8:
	...
	i32.const	$push39=, .L.str.46
	call    	eosio_assert@FUNCTION, $pop38, $pop39
	br      	1
.LBB12_10:
	end_block
	i32.const	$push166=, 0
	i32.const	$push40=, .L.str.46
...
_ZN5eosio11multi_indexILy3607749778735104000EN4dice7accountEJEE6modifyIZNS1_13pay_and_cleanERKNS1_4gameERKNS1_5offerESA_EUlRT_E_EEvRKS2_yOSB_:
	...
	i32.const	$push55=, 48
	i32.sub 	$push82=, $pop54, $pop55
	tee_local	$push81=, $8=, $pop82
	i32.store	__stack_pointer($pop56), $pop81
	i32.load	$push0=, 32($1)
	i32.eq  	$push1=, $pop0, $0
	i32.const	$push2=, .L.str.23
	call    	eosio_assert@FUNCTION, $pop1, $pop2
	...
	i32.const	$push78=, 16
	i32.add 	$push17=, $pop79, $pop78
	i64.load	$7=, 0($pop17)
	i64.load	$4=, 0($1)
	i64.load	$push77=, 8($3)
	tee_local	$push76=, $5=, $pop77
	i64.const	$push75=, 1
	i64.shl 	$push74=, $pop76, $pop75
	tee_local	$push73=, $6=, $pop74
	i64.const	$push14=, 4611686018427387904
	i64.lt_u	$push15=, $pop73, $pop14
	i64.const	$push7=, 63
	i64.shr_s	$push9=, $5, $pop7
	i64.const	$push72=, 1
	i64.shl 	$push10=, $pop9, $pop72
	i64.const	$push71=, 63
	i64.shr_u	$push8=, $5, $pop71
	i64.or  	$push70=, $pop10, $pop8
	tee_local	$push69=, $5=, $pop70
	i64.const	$push11=, 0
	i64.lt_s	$push12=, $pop69, $pop11
	i64.eqz 	$push13=, $5
	i32.select	$push16=, $pop15, $pop12, $pop13
	i32.const	$push18=, .L.str.43
	call    	eosio_assert@FUNCTION, $pop16, $pop18
	i64.const	$push22=, -4611686018427387904
	i64.gt_u	$push23=, $6, $pop22
	i64.const	$push19=, -1
	i64.gt_s	$push21=, $5, $pop19
	i64.const	$push68=, -1
	i64.eq  	$push20=, $5, $pop68
	i32.select	$push24=, $pop23, $pop21, $pop20
	i32.const	$push25=, .L.str.44
	call    	eosio_assert@FUNCTION, $pop24, $pop25
	i32.const	$push67=, 16
	i32.add 	$push26=, $1, $pop67
	i64.load	$push27=, 0($pop26)
	i64.eq  	$push28=, $7, $pop27
	i32.const	$push29=, .L.str.32
	call    	eosio_assert@FUNCTION, $pop28, $pop29
	i64.load	$push30=, 8($1)
	i64.add 	$push66=, $pop30, $6
	tee_local	$push65=, $5=, $pop66
	i64.store	8($1), $pop65
	i64.const	$push64=, -4611686018427387904
	i64.gt_s	$push31=, $5, $pop64
	i32.const	$push32=, .L.str.33
	call    	eosio_assert@FUNCTION, $pop31, $pop32
	i64.load	$push33=, 8($1)
	i64.const	$push63=, 4611686018427387904
	i64.lt_s	$push34=, $pop33, $pop63
	i32.const	$push35=, .L.str.34
	call    	eosio_assert@FUNCTION, $pop34, $pop35
	i32.load	$push36=, 28($1)
	i32.const	$push37=, -1
	i32.add 	$push38=, $pop36, $pop37
	i32.store	28($1), $pop38
	i64.load	$push39=, 0($1)
	i64.eq  	$push40=, $4, $pop39
	i32.const	$push41=, .L.str.25
	call    	eosio_assert@FUNCTION, $pop40, $pop41
	i32.const	$push42=, 32
	i32.add 	$push43=, $8, $pop42
	i32.store	40($8), $pop43
	i32.store	36($8), $8
	i32.store	32($8), $8
	i32.const	$push60=, 32
	i32.add 	$push61=, $8, $pop60
	i32.call	$drop=, _ZlsIN5eosio10datastreamIPcEEERT_S5_RKN4dice7accountE@FUNCTION, $pop61, $1
	i32.load	$push44=, 36($1)
	i32.const	$push62=, 32
	call    	db_update_i64@FUNCTION, $pop44, $2, $8, $pop62
	block   	
	i64.load	$push45=, 16($0)
	i64.lt_u	$push46=, $4, $pop45
	br_if   	0, $pop46
	i32.const	$push84=, 16
	i32.add 	$push52=, $0, $pop84
	i64.const	$push50=, -2
	i64.const	$push83=, 1
	i64.add 	$push49=, $4, $pop83
	i64.const	$push47=, -3
	i64.gt_u	$push48=, $4, $pop47
	i64.select	$push51=, $pop50, $pop49, $pop48
	i64.store	0($pop52), $pop51
.LBB36_2:
	end_block
	i32.const	$push59=, 0
	i32.const	$push57=, 48
